...
public class DotBehaviour : MonoBehaviour
{
    ...
    // Shows the dot if headed left or right
    public bool isLeft;
    ...
    public void Rotate(bool clockWise) {
        ...
        if (isLeft) {
            if (clockWise) {
                ...
                Vector3 hexSideTargetPosition = boardManager.objCoords[slaveTopX, slaveTopY].transform.position;
                Vector3 hexTopTargetPosition = boardManager.objCoords[slaveBotX, slaveBotY].transform.position;
                Vector3 hexBotTargetPosition = boardManager.objCoords[slaveSideX, slaveSideY].transform.position;
                ...
                Vector3 hexSideTargetPosition = boardManager.objCoords[slaveBotX, slaveBotY].transform.position;
                Vector3 hexTopTargetPosition =  boardManager.objCoords[slaveSideX, slaveSideY].transform.position;
                Vector3 hexBotTargetPosition =  boardManager.objCoords[slaveTopX, slaveTopY].transform.position;
